...
CREATE FUNCTION public.count_individuals(
    ...
    _min_age_of_onset integer,
    _max_age_of_onset integer,
...
BEGIN
    ...
    RETURN QUERY EXECUTE _query
        USING _disease_code, _disease_code_vocabulary, _min_age_of_onset, _max_age_of_onset;
END
$$;
...
-- * age of onset: for the first time in someones history.